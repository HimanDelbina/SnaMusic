...
import 'NavaSelect.dart';

class NavaHome extends StatefulWidget {
  List selectItem = [];
  NavaHome({this.selectItem});
  @override
  _NavaHomeState createState() => _NavaHomeState();
}

class _NavaHomeState extends State<NavaHome> {
  @override
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Image.asset(
                            ...
                            height: 23.0,
                            color: itemShow.listViewColorNava,
                          ),
                        ),
                        InkWell(
                          onTap: () {
                          ...
                          child: Image.asset(
                            ...
                            height: 20.0,
                            color: itemShow.gridViewColorNava,
                          ),
                        ),
                      ],
                    ),
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (BuildContext context) => PageShow()));
                      },
                      child: Container(
                        height: myHeight * 0.07,
                        width: myWidth * 0.14,
