...
class DastgahHome extends StatefulWidget {
  List selectItem = [];
  DastgahHome({this.selectItem});
  @override
  _DastgahHomeState createState() => _DastgahHomeState();
}

class _DastgahHomeState extends State<DastgahHome> {
  @override
                        ...
                        children: [
                          InkWell(
                            ...
                            child: Image.asset(
                              ...
                              height: 23.0,
                              color: itemShow.listViewColorDastgah,
                            ),
                          ),
                          InkWell(
                            onTap: () {
                            ...
                            child: Image.asset(
                              ...
                              height: 20.0,
                              color: itemShow.gridViewColorDastgah,
                            ),
                          ),
                        ],
                      ),
